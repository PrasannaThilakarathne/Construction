...
import Controller.ProjectDetail;
...
public final class Home extends javax.swing.JFrame {
    ...
    void loadProjects(){
        plist = dbop.getProjects();
        ProjectDetail pdetails = new ProjectDetail(plist);
        jTable1.setModel(pdetails);
    }
    /**
    ...
    private void btnViewProjectsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewProjectsActionPerformed
       ...
       {
           JOptionPane.showMessageDialog(rootPane, "Please Select a Project from above table");
       }
